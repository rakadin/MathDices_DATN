...
public class Gif_PopUp_Controller {
    ...
    public void show_magic_book(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
        gifphy.setImageResource(R.drawable.magic_book_gif);// insert gif need
        dialog.show();
    }
    public void show_roll_dice(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
        gifphy.setImageResource(R.drawable.dice_roll_gif);// insert gif need
        dialog.show();
    }
    public void show_egg_hoo(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
        gifphy.setImageResource(R.drawable.egg_hoo_gif);// insert gif need
        dialog.show();
    }
    public void show_egg_dancing(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
        gifphy.setImageResource(R.drawable.egg_gif);// insert gif need
        dialog.show();
    }
    public void show_egg_check_answer(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
        gifphy.setImageResource(R.drawable.egg_questions_gif);// insert gif need
        dialog.show();
    }
    public void show_egg_check_crying(Dialog dialog)
    {
        dialog.setContentView(R.layout.pop_up_layout_gif);
        GifImageView gifphy ;
        gifphy = dialog.findViewById(R.id.gif_inset);
