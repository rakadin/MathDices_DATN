...
public class Winning_activity_slide_2 extends AppCompatActivity {
    Button replayBut;
    Button menuBut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundControl.winSoundFun(Winning_activity_slide_2.this);
...
//                soundControl.PopSoundFun(Winningactivity.this,);
                soundControl.PopSoundFun2(Winning_activity_slide_2.this,replayBut);
                Intent intent = new Intent();
                intent.setClass(Winning_activity_slide_2.this, Slide_game_2_activity.class);
...
//                soundControl.player.pause();
        ...
        menuBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                soundControl.PopSoundFun2(Winning_activity_slide_2.this,replayBut);
                Intent intent = new Intent();
                intent.setClass(Winning_activity_slide_2.this, Part2_Homepage_Activity.class);
                startActivity(intent);
            }
        });
    }
